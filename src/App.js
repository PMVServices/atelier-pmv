...
import {genHtml, imprimerFiche, telechargerZip, imprimerRapport, apercuRapport} from "./pdfUtils";
...
function PageRapport({ficheId,techs,onRetour}){
  ...
  return(<div style={{maxWidth:820,margin:"0 auto",padding:"20px 16px"}}>
    ...
    <div style={{display:"flex",gap:10,flexWrap:"wrap",marginBottom:30}}>
      ...
      <button style={{...S.p1,background:"#22863A"}} onClick={exporter}>📄 Exporter en PDF</button>
    </div>
  </div>);
}
